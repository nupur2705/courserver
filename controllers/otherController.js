...
export const contact = catchAsyncError(async(req,res,next)=>{
    ...
    if (!name || !email || !message)return next(new ErrorHandler("Please enter fields", 400));
...
export const getDashboardStats = catchAsyncError(async (req, res, next) => {
    ...
    if (statsData[10].subscription === 0)
      ...
      const difference = {
        users: statsData[10].users - statsData[11].users ,
        views:  statsData[10].views - statsData[11].views ,
        subscription: statsData[10].subscription - statsData[11].subscription,
      };
